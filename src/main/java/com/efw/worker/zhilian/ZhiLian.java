package com.efw.worker.zhilian;

import com.efw.application.entity.ZhilianJobDataEntity;
...
public class ZhiLian {
    ...
    private boolean deliverCurrentPage(String keyword) {
        try {
            ...
            try {
                saveCurrentPageHtml();
                log.info("已保存当前页面到 output/debug/zhilian-page.html 以便排查");
    ...
    private void saveCurrentPageHtml() {
        try {
            ...
            java.nio.file.Path path = java.nio.file.Paths.get("output/debug/zhilian-page.html");
